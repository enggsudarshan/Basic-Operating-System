	.file	"sample0.c"
	.version	"01.01"
.stabs "/home/user/csc159/Phase0/lab1/",100,0,0,.Ltext0
...
.text
	.align 4
.stabs "DispMsg:F1",36,0,5,DispMsg
.stabs "d:p1",160,0,5,8
.stabs "e:p1",160,0,5,12
.stabs "f:p1",160,0,5,16
.globl DispMsg
	.type	 DispMsg,@function
DispMsg:
.stabn 68,0,5,.LM1-DispMsg
.LM1:
	pushl %ebp
	movl %esp,%ebp
.stabn 68,0,6,.LM2-DispMsg
.LM2:
	movl 8(%ebp),%eax
	pushl %eax
	pushl $.LC0
...
.Lfe1:
	...
	.align 4
.stabs "main:F19",36,0,12,main
.globl main
	.type	 main,@function
main:
.stabn 68,0,12,.LM6-main
.LM6:
	pushl %ebp
	movl %esp,%ebp
	subl $12,%esp
...
.Lfe2:
	.size	 main,.Lfe2-main
.stabs "a:1",128,0,13,-4
.stabs "b:1",128,0,13,-8
.stabs "c:1",128,0,13,-12
